...
export const availableCategories = [
  new Category("c1", "Italian", "#800080"),      
  new Category("c2", "Quick & Easy", "#FF0000"), 
  new Category("c3", "Hamburgers", "#FFA500"),   
  new Category("c4", "German", "#FFC107"),      
  new Category("c5", "Light & Lovely", "#2196F3"), 
  new Category("c6", "Exotic", "#4CAF50"),      
  new Category("c7", "Breakfast", "#03A9F4"),   
  new Category("c8", "Asian", "#8BC34A"),        
  new Category("c9", "French", "#E91E63"),       
  new Category("c10", "Summer", "#009688"),      
];
...
export const dummyMeals = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Toss the pan regularly so schnitzels are surrounded by oil and the crumbing becomes fluffy.',
      'Remove, and drain on kitchen paper. Fry the parsley in the remaining oil and drain.',
      'Serve schnitzels garnished with parsley and lemon slices.',
    ],
    isGlutenFree: false,
    isVegan: false,
    isVegetarian: false,
  ...
  },
  {
    ...
    steps: [
      ...
      'Process onion, garlic and ginger into paste and sauté',
      'Add cayenne pepper and almonds',
